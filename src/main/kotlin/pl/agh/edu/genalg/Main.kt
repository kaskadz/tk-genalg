...
import pl.agh.edu.genalg.framework.MaxIterationsStopCondition
...
fun main() {
    ...
    val stopCondition = MaxIterationsStopCondition<Archer, EvaluatedArcher, ArcherHyperparameters>(hyperparameters)
    ...
    while (!stopCondition.shouldStop(iterationCount++, evaluatedPopulation)) {
        ...
        val evaluatedEntities = evaluator.evaluatePopulation(Population(newPopulation))
